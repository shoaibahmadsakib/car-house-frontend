  ...
  return (
    <div className="App">
      ...
      <p>React is a JavaScript Libarary for building user interfaces
        ...
        It has a JSX element. It can use Props by parents to children, and It work just like a block element ,which is component
      ...
      <p>Use state is a Hook. Here Have a initial state and a update value state. Behind the seen It's look like a array, and a function.
        Here You can create a value and Update by using "useState"
      </p>
      </div>
